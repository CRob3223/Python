#Tutorial from Geeks for Geeks, https://www.geeksforgeeks.org/scientific-gui-calculator-using-tkinter-in-python/
...
btnZero = Button(calc, text="0",width=6,
				height=2,bg='black',fg='light grey',
				font=('Helvetica',20,'bold'),
...
lblDisplay = Label(calc, text = "Scientific Calculator",
				...
				bg='black',fg='light grey',justify=CENTER)
